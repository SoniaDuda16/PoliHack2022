<?php 
function showClinicEmergency($title, $address, $phone, $person){ ?>
    <div class="card shadow mb-4">
        <div class="card-body p-5">
            ...
            <ul class="list-unstyled list pl-5">
                ...
                <li class="mb-3 d-flex align-items-center"><i class="fa fa-phone-square mr-3 text-primary"></i> &nbsp; Număr de urgență : <?php echo $phone; ?></li>
            </ul>
        </div>
    </div>
