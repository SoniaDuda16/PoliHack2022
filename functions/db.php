...
function dbConnect($dbC){
        ...
        if($connection){
            ...
            $connection->query("CREATE TABLE IF NOT EXISTS ".$dbC->db_programari."( id SERIAL primary key, idclinic Integer not null, data Varchar(255) not null, ora Varchar(255), specializare Varchar(255), isfree Integer default 1, iduser Integer default -1)");
