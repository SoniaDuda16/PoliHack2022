...
function dbConnect($dbC){
        ...
        if($connection){
            ...
            $connection->query("CREATE TABLE IF NOT EXISTS ".$dbC->db_usersTable."( id SERIAL primary key, username Varchar(255) not null, password Varchar(255) not null, fullname Varchar(255) not null, level Integer default 0, hospid Integer)");
