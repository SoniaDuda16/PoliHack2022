...
function dbConnect($dbC){
        ...
        if($connection){
            ...
            $connection->query("CREATE TABLE IF NOT EXISTS ".$dbC->db_clinicsReqsTable."( id SERIAL primary key, name Varchar(255) not null, adress Varchar(255) not null, phone Varchar(255) not null, idreprez Integer not null, hasemergency Integer not null, emergency Varchar(255) not null)");
            $connection->query("CREATE TABLE IF NOT EXISTS ".$dbC->db_clinicsTable."( id SERIAL primary key, name Varchar(255) not null, adress Varchar(255) not null, phone Varchar(255) not null, idreprez Integer not null, hasemergency Integer not null, emergency Varchar(255) not null)");
