    ...
    <div class="container-fluid bg-primary py-5 hero-header mb-5">
        <div class="row py-3">
            <div class="col-12 text-center">
                <h1 class="display-3 text-white animated zoomIn">Despre Noi</h1>
            </div>
        </div>
    </div>
    <!-- Hero End -->
    ...
    <!-- About Start AICI SCHIMBAM TEXTUL-->
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body p-5">
                            <h4 class="text-body fst-italic mb-4">Înregistrează o clinică sau un cabinet: </h4>
                            <!-- List with bullets -->
                            <ul class="list-bullets">
                    ...
                    <a href="index.php?page=register" class="btn btn-primary py-3 px-5 mt-4 wow zoomIn" data-wow-delay="0.6s">Înregistrează-te</a>
                </div> 
