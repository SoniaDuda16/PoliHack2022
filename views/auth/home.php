                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="appointment.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Conectează-te</a>
                            <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Inregistrează-te</a>
                        </div>
                    </div>
                </div>
